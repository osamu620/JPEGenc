...
static void make_zigzag_blk_simd(int16_t *HWY_RESTRICT sp, int c, int &prev_dc, bitstream &enc) {
  ...
  //  const hn::FixedTag<int8_t, 16> s8;
  ...
  //  // clang-format off
  //  const auto idx_rows_0123_0 = Load(u8, bc + 0 * DCTSIZE); const auto idx_rows_4567_0 = Load(u8, bc + 8
  //  * DCTSIZE); const auto idx_rows_0123_1 = Load(u8, bc + 2 * DCTSIZE); const auto idx_rows_4567_1 =
  //  Load(u8, bc + 10 * DCTSIZE); const auto idx_rows_0123_2 = Load(u8, bc + 4 * DCTSIZE); const auto
  //  idx_rows_4567_2 = Load(u8, bc + 12 * DCTSIZE); const auto idx_rows_0123_3 = Load(u8, bc + 6 *
  //  DCTSIZE); const auto idx_rows_4567_3 = Load(u8, bc + 14 * DCTSIZE);
  //
  //  const auto tbl_rows_0123_0 = Load(s8, (int8_t *)(sp + 0 * DCTSIZE)); const auto tbl_rows_4567_0 =
  //  Load(s8, (int8_t *)(sp + 4 * DCTSIZE)); const auto tbl_rows_0123_1 = Load(s8, (int8_t *)(sp + 1 *
  //  DCTSIZE)); const auto tbl_rows_4567_1 = Load(s8, (int8_t *)(sp + 5 * DCTSIZE)); const auto
  //  tbl_rows_0123_2 = Load(s8, (int8_t *)(sp + 2 * DCTSIZE)); const auto tbl_rows_4567_2 = Load(s8,
  //  (int8_t *)(sp + 6 * DCTSIZE)); const auto tbl_rows_0123_3 = Load(s8, (int8_t *)(sp + 3 * DCTSIZE));
  //  const auto tbl_rows_4567_3 = Load(s8, (int8_t *)(sp + 7 * DCTSIZE));
  //  // clang-format on
  //
  //  const auto tbl_rows_2345_0 = tbl_rows_0123_2;
  //  const auto tbl_rows_2345_1 = tbl_rows_0123_3;
  //  const auto tbl_rows_2345_2 = tbl_rows_4567_0;
  //  const auto tbl_rows_2345_3 = tbl_rows_4567_1;
  //  const auto tbl_rows_567_0  = tbl_rows_4567_1;
  //  const auto tbl_rows_567_1  = tbl_rows_4567_2;
  //  const auto tbl_rows_567_2  = tbl_rows_4567_3;

  const uint8x16x4_t idx_rows_0123 = vld1q_u8_x4(bc + 0 * DCTSIZE);
  const uint8x16x4_t idx_rows_4567 = vld1q_u8_x4(bc + 8 * DCTSIZE);
